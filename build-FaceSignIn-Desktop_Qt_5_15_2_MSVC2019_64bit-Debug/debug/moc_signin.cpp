...
QT_MOC_LITERAL(1, 7, 10), // "OpenCamrea"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 11) // "CheckStatus"

    },
    "SignIn\0OpenCamrea\0\0CheckStatus"
};
...
void SignIn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignIn::OpenCamrea)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignIn::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignIn::CheckStatus)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SignIn::OpenCamrea()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignIn::CheckStatus()
{
