...
void QFaceSearchR::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QFaceSearchR *_t = static_cast<QFaceSearchR *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QFaceSearchR::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QFaceSearchR.data,
      qt_meta_data_QFaceSearchR,  qt_static_metacall, nullptr, nullptr}
};
...
void *QFaceSearchR::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QFaceSearchR.stringdata0))
        return static_cast<void*>(const_cast< QFaceSearchR*>(this));
